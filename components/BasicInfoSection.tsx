...
const styles = {
  ...
  headerText: 'text-lg font-bold text-primary drop-shadow-md',
  headerTextWhite: 'text-lg font-bold text-white font-gongGothicMedium drop-shadow-md',
  infoText: 'text-sm text-gray-500 drop-shadow-md',
  infoTextWhite: 'text-sm text-gray-50 drop-shadow-md',
};
